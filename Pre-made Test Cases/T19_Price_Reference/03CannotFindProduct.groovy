...
try {
    subTestInfo = "- Cannot Find Product"
    ...
    clickOn 'text:SEARCH' pause(pauseSmall)
    ...
    subTestInfo = "- Cannot Find Product Name"
    try {
        assertThat fxer['productName'].getText(), is(nullValue())
    ...
    subTestInfo = "- Cannot Find Product Price"
    try {
        assertThat fxer['productPrice'], hasText("0.00")

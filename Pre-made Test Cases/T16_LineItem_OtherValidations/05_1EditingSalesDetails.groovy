...
try {
    ...
    // 3) Editing Card Number     
    clickOn fxer['cardNo'] pause(pauseMedium)
    type cardNoValue pause(pauseMedium)

    subTestInfo = "- Editing Card Number"
    ...
    // 4) Editing Cash
    subTestInfo = "- Editing Cash"
    clickOn fxer['cash'] pause(pauseMedium)
    type cashAmtValue pause(pauseMedium)

...
def subTestInfo = " - Manager Account"

try {
    script.logger("INFO: Entering $testTitle...")
    clickOn 'text:MENU' pause(pauseLarge)
    clickOn 'text:Owner' pause(pauseLarge)
    clickOn 'text:Shutdown POS' pause(pauseLarge)

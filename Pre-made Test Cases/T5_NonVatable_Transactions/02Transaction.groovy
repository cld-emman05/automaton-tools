...
def testTitle = "NonVatable Transaction";
...
try {
        script.logger("INFO: Entering $testTitle Product\n")

        // OPTION 2: User shall transact using MENU ITEMS (clickable items) 
        clickOn fxer['button_6'] pause(pauseMedium) clickOn fxer['button_0'] pause(pauseMedium)
        
        // Define the quantity
        subTestInfo = " - Define the quantity"
        ...
        subTestInfo = " - Check computation of VAT"
        boolean successVatDetails = compute.checkNonVatableAmountDetails()
